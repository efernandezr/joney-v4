...
export default defineAction({
    description: "List active workspace connections explicitly available to the consuming app for creative-context source setup.",
    schema: z.object({
    ...
    run: async ({ provider }) => {
        ...
        return {
            ...
            provider,
            connections,
            autoSelectedConnectionId: connections.length === 1 ? connections[0].connectionId : null,
...
//# sourceMappingURL=list-context-connections.js.map