...
import { z } from "zod";
import { archiveContextPack, createContextPack, deriveContextPack, setContextPackPinned, } from "../store/index.js";
...
export default defineAction({
    description: "Create an immutable context pack, derive a new membership snapshot, change a separate user pin pointer, or archive a pack. Existing member rows are never mutated.",
    schema,
    agentInputSchema,
...
//# sourceMappingURL=manage-context-pack.js.map