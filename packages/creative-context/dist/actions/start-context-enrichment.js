...
export default defineAction({
    description: "Queue a durable, budgeted creative-context rebuild or enrichment job; top brand inputs run eagerly and the remainder stays pending/on-demand.",
    schema,
    needsApproval: true,
    ...
    run: async (args) => {
        const job = await createJob({
            ...
            kind: args.operation === "enrich-media"
                ? "enrich-media"
...
//# sourceMappingURL=start-context-enrichment.js.map