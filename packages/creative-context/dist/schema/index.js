import { createSharesTable, integer, ownableColumns, real, table, text, } from "@agent-native/core/db/schema";
...
export const contextSourceShares = createSharesTable("creative_context_source_shares");
...
export const brandProfileShares = createSharesTable("creative_context_brand_profile_shares");
...
export const contextPackShares = createSharesTable("creative_context_pack_shares");
...
export const creativeContextShares = createSharesTable("creative_context_shares");
...
export const creativeContextMemberships = table("creative_context_memberships", {
    id: text("id").primaryKey(),
    contextId: text("context_id").notNull(),
...
export const creativeContextSubmissions = table("creative_context_submissions", {
    id: text("id").primaryKey(),
    contextId: text("context_id").notNull(),
...
export const creativeContextAppBindings = table("creative_context_app_bindings", {
    id: text("id").primaryKey(),
...
export const creativeContextPublishedSnapshots = table("creative_context_published_snapshots", {
    id: text("id").primaryKey(),
    contextId: text("context_id").notNull(),
    sourceId: text("source_id").notNull(),
    membershipId: text("membership_id").notNull(),
