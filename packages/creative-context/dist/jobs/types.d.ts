import type { IngestionBudgetLimits, IngestionCheckpoint } from "@agent-native/core/ingestion";
import type { ContextImportConnectorRegistry } from "../connectors/registry.js";
import type { ContextConnectorExecutionContext, ContextConnectorInventoryItem } from "../connectors/types.js";
import type { ContextIngestBatch, ContextIngestResult, ContextImportInferenceResult, ContextJob, ContextSource } from "../types.js";
...
export interface RunContextImportJobOptions {
    ...
    limits?: Partial<IngestionBudgetLimits & {
        batchSize: number;
