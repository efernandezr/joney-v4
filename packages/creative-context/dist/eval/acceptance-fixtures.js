...
export const CREATIVE_CONTEXT_ACCEPTANCE_CASES = [
    {
        id: "launch-scorecard-slide",
        prompt: "Draft an executive launch scorecard slide.",
        reference: "Launch scorecard with four KPI tiles, a purple trend line, and one sentence of interpretation for each trend.",
        ...
        contextOn: {
            output: "Launch scorecard with four KPI tiles, a purple trend line, and one sentence of interpretation for each trend.",
    ...
    },
    {
        ...
        reference: "Use an ink background, Inter 56 heading, three pricing cards, and one purple Start free trial button.",
        ...
        contextOn: {
            output: "Use an ink background, Inter 56 heading, three pricing cards, and one purple Start free trial button.",
    ...
    },
    {
        ...
        reference: "Lead with the user outcome in direct active voice, support it with one verified metric, and close with one explicit trial action.",
        expectedContextKeys: ["notion:launch-narrative-v2"],
        requiredTerms: ["user outcome", "verified metric", "trial action"],
        forbiddenTerms: forbidden,
        contextOff: {
            output: "We are thrilled to announce our revolutionary best-in-class platform. Learn more today.",
            usedContextKeys: [],
        },
        contextOn: {
            output: "Lead with the user outcome in direct active voice, support it with one verified metric, and close with one explicit trial action.",
    ...
    },
    {
        ...
        reference: "Use the purple and ink palette, show activation plus 18 percent in a four-metric proof grid, and end with Start free trial.",
        ...
        forbiddenTerms: forbidden,
        contextOff: {
            output: "Use an attractive palette, a collection of metrics, and a compelling call to action.",
            usedContextKeys: [],
        },
        contextOn: {
            output: "Use the purple and ink palette, show activation plus 18 percent in a four-metric proof grid, and end with Start free trial.",
...
//# sourceMappingURL=acceptance-fixtures.js.map