...
export const nativeCreativeArtifactSchema = z
    ...
    .strict();
export function parseNativeCreativeArtifact(value) {
    return nativeCreativeArtifactSchema.parse(value);
}
export function nativeCreativeArtifactFromMetadata(metadata) {
    if (!metadata || typeof metadata !== "object" || Array.isArray(metadata)) {
        return null;
    }
    const result = nativeCreativeArtifactSchema.safeParse(metadata.nativeArtifact);
    return result.success ? result.data : null;
}
//# sourceMappingURL=native-artifact.js.map