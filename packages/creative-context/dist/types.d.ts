...
export declare const CREATIVE_CONTEXT_SOURCE_KINDS: readonly ["manual", "upload", "google-slides", "figma", "notion", "website", "native-app"];
export type ContextSourceKind = (typeof CREATIVE_CONTEXT_SOURCE_KINDS)[number];
export type ContextSourceHealth = "healthy" | "stale" | "error" | "needs_setup" | "paused";
export type ContextItemStatus = "active" | "deprecated" | "deleted" | "unavailable";
export type ContextCurationRank = "canonical" | "exemplar" | "normal" | "ignored";
export type UpstreamAccess = "available" | "restricted" | "unknown";
export type ContextCurationStatus = "included" | "excluded" | "review";
export type ContextJobKind = "import" | "embed" | "enrich-media" | "brand-dna" | "canonical-logo" | "layout-suggestion" | "metadata-refresh" | "pack-refresh" | "purge";
export type ContextJobStatus = "queued" | "running" | "paused" | "completed" | "failed" | "cancelled";
export type ContextImportMode = "incremental" | "full";
export type ContextFeedbackSignal = "helpful" | "not-helpful" | "incorrect" | "outdated";
...
export type ContextSourceSummary = Pick<ContextSource, "id" | "name" | "kind" | "externalRef" | "connectionId" | "containerOwnerVerifiedAt" | "upstreamAccess" | "status" | "healthStatus" | "itemCount" | "restrictedItemCount" | "lastSyncedAt" | "lastError" | "visibility" | "createdAt" | "updatedAt">;
...
export type CreativeContextSubmissionStatus = "pending" | "approved" | "rejected" | "withdrawn" | "superseded";
