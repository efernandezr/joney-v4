...
import { isInBackgroundFunctionRuntime, registerPackageActions, } from "@agent-native/core/server";
...
import { createCreativeContextWorkerPlugin, registerCreativeContextImportContinuationDispatcher, } from "../jobs/index.js";
...
import { configureCreativeContext, getCreativeContext, } from "./context.js";
...
function registerCreativeContextShareables() {
...
const creativeContextDbPlugin = runMigrations(creativeContextMigrations, { table: "creative_context_migrations" });
export function setupCreativeContext(options = {}) {
    const appId = options.appId ?? "creative-context";
    const defaultConnectorContext = createDefaultContextConnectorExecutionContext({ appId });
    ...
    if (options.continuationDispatcher) {
        registerCreativeContextImportContinuationDispatcher(options.continuationDispatcher);
    }
...
export { brandKitDataFromExtraction, buildDesignMarkdown, extractRenderedDesignSystemFromUrl, styleBriefFromRenderedDesign, } from "../connectors/rendered-design.js";
