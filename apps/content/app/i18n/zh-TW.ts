...
const messages = {
  ...
  editor: {
    ...
    properties: {
      ...
      clear: "清除",
      clearFilters_zero: "清除篩選器",
      clearFilters_one: "清除篩選器",
      clearFilters_two: "清除篩選器",
      clearFilters_few: "清除篩選器",
      clearFilters_many: "清除篩選器",
      clearFilters_other: "清除篩選器",
      clearValue: "清晰的價值",
      color: "顏色",
      computed: "計算的",
  ...
  database: {
    ...
    formEditorAccessRequired: "需要編輯者權限才能提交此表單。",
    formLongAnswerPlaceholder: "輸入詳細回覆...",
    formMoveQuestionDown: "將 {{name}} 下移",
    formMoveQuestionUp: "將 {{name}} 上移",
    formName: "名稱",
    formNotChecked: "未勾選",
    formOnePerLinePlaceholder: "每行輸入一個值",
    formQuestions: "問題",
    formQuestionsDescription: "選擇顯示的問題、標示必填項目並設定順序。",
    formRequired: "必填",
    formRequiredError: "此問題為必填。",
    formShowQuestion: "顯示",
    formSubmit: "提交",
    formSubmitFailed: "無法提交表單。",
    formSubmitted: "回覆已提交",
    formSubmittedDescription: "新的資料庫頁面已準備完成。",
    formSubmitting: "提交中...",
    addARowTo: "新增列至…",
    addASource: "新增來源",
    aField: "一個欄位",
  ...
  sidebar: {
    ...
    pagePermanentlyDeleted: "頁面已永久刪除",
    pageRestored: "頁面已還原",
    ...
    deletePageNamedPermanently: "永久刪除 {{title}}",
    deletePagePermanentlyDescription:
      "這會永久刪除「{{title}}」及其子頁面。此操作無法復原。",
    deletePagePermanentlyQuestion: "永久刪除頁面？",
    ...
    removeLocalFilesDescription:
      "這會從 Content 和側邊欄移除本機檔案項目。磁碟上的檔案不會被刪除。",
