...
describe("Content parity critical capability coverage", () => {
  ...
  // Skipped in the scaffolded workspace: coverage refs point at framework
  // monorepo paths (packages/core/src) that do not exist here.
  it.skip("points coverage refs at real files", () => {
