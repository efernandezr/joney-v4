...
const messages = {
  ...
  editorToolbar: {
    ...
    layers: "Camadas",
    closeLayers: "Fechar painel de camadas",
    expandLayer: "Expandir camada",
    collapseLayer: "Recolher camada",
    tweaks: "Ajustes",
  ...
  animations: {
    ...
    title: "Transições",
    close: "Fechar painel de transições",
    emptyTitle: "Aún no hay animaciones.",
    emptyDescription:
      "Selecione um objeto no slide para adicionar uma transição.",
    selectObject: "Selecione um objeto para animar",
    addTransition: "Adicionar transição",
    effect: "Efeito",
    trigger: "Gatilho",
    onClick: "Ao clicar",
    byParagraph: "Por parágrafo",
    expand: "Expandir transição",
    collapse: "Recolher transição",
    reorder: "Reordenar transição",
    remove: "Remover transição",
    play: "Reproduzir",
  ...
  deckEditor: {
    ...
    layoutOverflowDetails: "Mostrar detalhes do transbordamento",
    layoutOverflowVertical: "Transbordamento vertical: {{pixels}} px",
    layoutOverflowHorizontal: "Transbordamento horizontal: {{pixels}} px",
  ...
  designSystemSetup: {
    ...
    syncSource: "Sincronizar fonte",
    syncingSource: "Sincronizando fonte...",
    syncStarted: "Sincronização do sistema de design iniciada",
    syncFailed: "Não foi possível sincronizar o sistema de design",
    loadFailed:
  ...
  home: {
    ...
    referenceImportSelected: '"{{title}}" agora é o deck de referência.',
    continue: "Continuar",
    ...
    referenceReviewTitle: "Revisar referências",
    ...
    googleSlidesReferenceUnavailable:
      "Conecte o Google Drive e configure o Picker para importar um deck do Google Slides.",
