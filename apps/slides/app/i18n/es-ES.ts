...
const messages = {
  ...
  raw: {
    ...
    exitExcalidrawCanvas: "Salir del lienzo de dibujo",
  ...
  editorToolbar: {
    ...
    convertMermaidFailed: "No se pudo convertir el diagrama",
    ...
    layers: "Capas",
    closeLayers: "Cerrar panel de capas",
    expandLayer: "Expandir capa",
    collapseLayer: "Contraer capa",
  ...
  animations: {
    ...
    title: "Transiciones",
    close: "Cerrar panel de transiciones",
    emptyTitle: "Aún no hay animaciones.",
    emptyDescription:
      "Selecciona un objeto de la diapositiva para añadir una transición.",
    selectObject: "Selecciona un objeto para animarlo",
    addTransition: "Añadir transición",
    effect: "Efecto",
    trigger: "Activador",
    onClick: "Al hacer clic",
    byParagraph: "Por párrafo",
    expand: "Expandir transición",
    collapse: "Contraer transición",
    reorder: "Reordenar transición",
    remove: "Eliminar transición",
    play: "Reproducir",
  ...
  editorSidebar: {
    ...
    newSlideSaveFailed:
      "No se pudo guardar la nueva diapositiva. Inténtalo de nuevo.",
  ...
  deckEditor: {
    ...
    layoutOverflowWarning: "El diseño se desborda",
    layoutOverflowDetails: "Mostrar detalles del desbordamiento",
    layoutOverflowVertical: "Desbordamiento vertical: {{pixels}} px",
    layoutOverflowHorizontal: "Desbordamiento horizontal: {{pixels}} px",
  ...
  designSystemSetup: {
    ...
    syncSource: "Sincronizar fuente",
    syncingSource: "Sincronizando fuente...",
    syncStarted: "Sincronización del sistema de diseño iniciada",
    syncFailed: "No se pudo sincronizar el sistema de diseño",
    loadFailed:
  ...
  home: {
    ...
    referenceImportSelected: '"{{title}}" es ahora el deck de referencia.',
    continue: "Continuar",
