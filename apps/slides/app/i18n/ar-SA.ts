...
const messages = {
  ...
  editorToolbar: {
    ...
    convertMermaidFailed: "فشل تحويل المخطط",
    ...
    layers: "الطبقات",
    closeLayers: "إغلاق لوحة الطبقات",
    expandLayer: "توسيع الطبقة",
    collapseLayer: "طي الطبقة",
    tweaks: "تعديلات",
  ...
  animations: {
    ...
    title: "الانتقالات",
    close: "إغلاق لوحة الانتقالات",
    emptyTitle: "Aún no hay animaciones.",
    emptyDescription: "حدد كائنًا في الشريحة لإضافة انتقال.",
    selectObject: "حدد كائنًا لتحريكه",
    addTransition: "إضافة انتقال",
    effect: "التأثير",
    trigger: "المشغل",
    onClick: "عند النقر",
    byParagraph: "حسب الفقرة",
    expand: "توسيع الانتقال",
    collapse: "طي الانتقال",
    reorder: "إعادة ترتيب الانتقال",
    remove: "إزالة الانتقال",
    play: "تشغيل",
  ...
  deckEditor: {
    ...
    layoutOverflowDetails: "عرض تفاصيل التجاوز",
    layoutOverflowVertical: "التجاوز الرأسي: {{pixels}} بكسل",
    layoutOverflowHorizontal: "التجاوز الأفقي: {{pixels}} بكسل",
  ...
  designSystemSetup: {
    ...
    sourceLabel: "المصدر",
    sourceFigma: "ملف Figma",
    sourceCode: "ملفات التعليمات البرمجية",
    ...
    sourceIndexedDocsOnly: "تمت فهرسة {{docs}} مستندات",
    sourceIndexedTokensOnly: "تمت فهرسة {{tokens}} رموز",
    sourceUnavailableDescription: "تعذر على Builder تحميل أحدث نتائج المصدر.",
    sourceOpenInBuilder: "فتح في Builder",
    syncSource: "مزامنة المصدر",
    syncingSource: "جارٍ مزامنة المصدر...",
    syncStarted: "بدأت مزامنة نظام التصميم",
    syncFailed: "تعذرت مزامنة نظام التصميم",
    loadFailed: "تعذر تحميل نظام التصميم هذا. أغلقه وحاول مرة أخرى.",
    otherSources: "أخرى",
    otherSourcesDescription:
      "الاتصال من موقع ويب أو رمز أو ملفات أو نظام تصميم موجود.",
    chooseSourcePrompt: "اختر مصدرًا لتهيئته",
    loading: "جارٍ تحميل نظام التصميم",
  ...
  home: {
    ...
    referenceImportSelected: 'أصبح "{{title}}" العرض المرجعي الآن.',
    continue: "متابعة",
