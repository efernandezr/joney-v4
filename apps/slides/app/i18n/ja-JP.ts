...
const messages = {
  ...
  animations: {
    ...
    title: "トランジション",
    close: "トランジション パネルを閉じる",
    emptyTitle: "还没有动画。",
    emptyDescription:
      "トランジションを追加するオブジェクトをスライド上で選択してください。",
    selectObject: "アニメーションするオブジェクトを選択",
    ...
    byParagraph: "段落ごと",
    expand: "トランジションを展開",
    collapse: "トランジションを折りたたむ",
    reorder: "トランジションを並べ替え",
    remove: "トランジションを削除",
    play: "再生",
    clearAll: "全部清除",
    elements: "元素",
