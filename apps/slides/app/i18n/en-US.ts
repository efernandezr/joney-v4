...
const messages = {
  ...
  raw: {
    ...
    routeNotFoundTitle: "Not Found - Slides",
    routeEditorTitle: "Editor — Slides",
    routeDesignSystemsTitle: "Design Systems - Slides",
    routeSettingsTitle: "Settings - Slides",
    routeSharedTitle: "Shared Presentation",
    routeTeamTitle: "Team — Slides",
  ...
  editorToolbar: {
    ...
    convertMermaidFailed: "Failed to convert diagram",
    ...
    layers: "Layers",
    closeLayers: "Close layers panel",
    ...
    editorLinkDescription: "Opens the deck in the editor",
  ...
  animations: {
    ...
    title: "Transitions",
    close: "Close transitions panel",
    emptyTitle: "No animations yet.",
    emptyDescription: "Select an object on the slide to add a transition.",
    selectObject: "Select an object to animate",
  ...
  history: {
    ...
    backToSavedVersions: "Back to history",
    savedVersions: "History",
    description: "Browse deck history and restore a previous snapshot.",
    untitled: "Untitled",
  ...
  deckEditor: {
    ...
    layoutOverflowWarning: "Layout overflows",
    layoutOverflowDetails: "Show overflow details",
    layoutOverflowVertical: "Vertical overflow: {{pixels}}px",
    layoutOverflowHorizontal: "Horizontal overflow: {{pixels}}px",
  ...
  designSystemSetup: {
    ...
    newDescription:
      "Connect Figma, code, and optional design.md guidance through Builder DSI.",
    companyBrand: "Company / Brand",
    companyBrandPlaceholder: "Acme Inc. — We build developer tools...",
    figmaFile: "Connect Figma",
    parsingFigmaFile: "Starting Builder DSI indexing...",
    uploadFigDescription: "Upload a .fig local copy for Builder DSI",
    builderIndexingStarted: "Builder indexing started",
    ...
    syncStarted: "Design system sync started",
    syncFailed: "Could not sync design system",
  ...
  home: {
    ...
    referenceImportSelected: '"{{title}}" is now the reference deck.',
    continue: "Continue",
