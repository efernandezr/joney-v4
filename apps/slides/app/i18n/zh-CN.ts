...
const messages = {
  ...
  animations: {
    ...
    close: "关闭过渡面板",
    emptyTitle: "还没有动画。",
    emptyDescription: "选择幻灯片上的对象以添加过渡。",
    selectObject: "选择要添加动画的对象",
    addTransition: "添加过渡",
    effect: "效果",
    trigger: "触发方式",
    onClick: "点击时",
  ...
  editorSidebar: {
    ...
    newSlideSaveFailed: "无法保存新幻灯片,请重试。",
    addSlides: "添加幻灯片",
  ...
  deckEditor: {
    ...
    requestAccessDialogDescription:
      "请登录，或输入所有者应与此幻灯片共享的电子邮件地址。",
    requestAccessSignIn: "登录或注册",
    requestAccessOr: "或",
    requestAccessEmailLabel: "电子邮件地址",
    requestAccessEmailPlaceholder: "you@example.com",
    requestAccessEmailHint: "获得访问权限后，请使用此邮箱登录以查看幻灯片。",
    requestAccessWithEmail: "通过邮箱请求",
    requestAccessEmailRequired: "请输入有效的电子邮件地址。",
    requestingAccess: "正在请求访问权限…",
    accessRequestSentWithEmail: "已请求所有者与 {{email}} 分享此幻灯片。",
    ...
    accessApprovalSignInMessage:
      "请以幻灯片所有者或管理员身份登录以批准此请求。",
    accessApprovalOpenDeck: "打开幻灯片",
    ...
    layoutOverflowWarning: "布局溢出",
    layoutOverflowDetails: "显示溢出详情",
  ...
  designSystemSetup: {
    ...
    updated: "设计系统已更新",
    sourceLabel: "来源",
    sourceFigma: "Figma 文件",
    sourceCode: "代码文件",
    sourceGitHub: "GitHub 存储库",
    sourceMixed: "多个来源",
    sourceBuilder: "Builder 设计系统智能",
    sourceIndexingDescription:
      "Builder 仍在处理此来源。结果准备好后会显示在这里。",
    sourceIndexedDescription: "已索引 {{docs}} 个文档 · {{tokens}} 个令牌",
    sourceIndexedDocsOnly: "已索引 {{docs}} 个文档",
    sourceIndexedTokensOnly: "已索引 {{tokens}} 个令牌",
    sourceUnavailableDescription: "Builder 无法加载最新的来源结果。",
    sourceOpenInBuilder: "在 Builder 中打开",
    syncSource: "同步来源",
    syncingSource: "正在同步来源...",
    syncStarted: "设计系统同步已开始",
    syncFailed: "无法同步设计系统",
    loadFailed: "无法加载此设计系统。请关闭后重试。",
    otherSources: "其他",
  ...
  home: {
    ...
    referenceImportSelected: "“{{title}}”现已设为参考幻灯片。",
    continue: "继续",
