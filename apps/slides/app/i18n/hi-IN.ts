...
const messages = {
  ...
  editorToolbar: {
    ...
    layers: "लेयर्स",
    closeLayers: "लेयर्स पैनल बंद करें",
    expandLayer: "लेयर विस्तृत करें",
    collapseLayer: "लेयर संक्षिप्त करें",
    tweaks: "ट्वीक्स",
  ...
  animations: {
    ...
    title: "ट्रांज़िशन",
    close: "ट्रांज़िशन पैनल बंद करें",
    emptyTitle: "अभी कोई एनिमेशन नहीं।",
    emptyDescription: "ट्रांज़िशन जोड़ने के लिए स्लाइड पर कोई ऑब्जेक्ट चुनें।",
    selectObject: "ऐनिमेट करने के लिए ऑब्जेक्ट चुनें",
    addTransition: "ट्रांज़िशन जोड़ें",
    effect: "प्रभाव",
    trigger: "ट्रिगर",
    onClick: "क्लिक पर",
    byParagraph: "पैराग्राफ़ के अनुसार",
    expand: "ट्रांज़िशन फैलाएं",
    collapse: "ट्रांज़िशन समेटें",
    reorder: "ट्रांज़िशन का क्रम बदलें",
    remove: "ट्रांज़िशन हटाएं",
    play: "चलाएं",
  ...
  deckEditor: {
    ...
    layoutOverflowWarning: "लेआउट ओवरफ्लो हो रहा है",
    layoutOverflowDetails: "ओवरफ्लो विवरण दिखाएं",
    layoutOverflowVertical: "लंबवत ओवरफ्लो: {{pixels}} px",
    layoutOverflowHorizontal: "क्षैतिज ओवरफ्लो: {{pixels}} px",
  ...
  designSystemSetup: {
    ...
    sourceLabel: "स्रोत",
    sourceFigma: "Figma फ़ाइल",
    sourceCode: "कोड फ़ाइलें",
    ...
    sourceIndexedDocsOnly: "{{docs}} दस्तावेज़ इंडेक्स किए गए",
    sourceIndexedTokensOnly: "{{tokens}} टोकन इंडेक्स किए गए",
    sourceUnavailableDescription: "Builder नवीनतम स्रोत परिणाम लोड नहीं कर सका।",
    sourceOpenInBuilder: "Builder में खोलें",
    syncSource: "स्रोत सिंक करें",
    syncingSource: "स्रोत सिंक हो रहा है...",
    syncStarted: "डिज़ाइन सिस्टम सिंक शुरू हुआ",
    syncFailed: "डिज़ाइन सिस्टम सिंक नहीं हो सका",
    loadFailed: "यह डिज़ाइन सिस्टम लोड नहीं हो सका। बंद करके फिर कोशिश करें।",
    otherSources: "अन्य",
    ...
    loading: "डिज़ाइन सिस्टम लोड हो रहा है",
