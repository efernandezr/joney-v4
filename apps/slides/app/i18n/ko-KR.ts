...
const messages = {
  ...
  editorToolbar: {
    ...
    convertMermaidFailed: "다이어그램 변환 실패",
    ...
    layers: "레이어",
    closeLayers: "레이어 패널 닫기",
    expandLayer: "레이어 펼치기",
    collapseLayer: "레이어 접기",
    tweaks: "조정",
  ...
  animations: {
    ...
    close: "전환 패널 닫기",
    emptyTitle: "还没有动画。",
    emptyDescription: "전환을 추가하려면 슬라이드에서 개체를 선택하세요.",
    selectObject: "애니메이션할 개체 선택",
    addTransition: "전환 추가",
    effect: "효과",
    trigger: "트리거",
    onClick: "클릭 시",
  ...
  deckEditor: {
    ...
    layoutOverflowDetails: "넘침 세부 정보 표시",
    layoutOverflowVertical: "세로 넘침: {{pixels}}px",
    layoutOverflowHorizontal: "가로 넘침: {{pixels}}px",
  ...
  designSystemSetup: {
    ...
    syncSource: "소스 동기화",
    syncingSource: "소스 동기화 중...",
    syncStarted: "디자인 시스템 동기화가 시작되었습니다",
    syncFailed: "디자인 시스템을 동기화하지 못했습니다",
    loadFailed:
  ...
  home: {
    ...
    referenceImportSelected: '"{{title}}"이(가) 참고 덱으로 선택되었습니다.',
    continue: "계속",
