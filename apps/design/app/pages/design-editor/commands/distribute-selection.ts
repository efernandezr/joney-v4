...
import type { DesignHotkeyDistributeAxis } from "@/hooks/useDesignHotkeys";
...
import { computeDistributedPositions } from "@/pages/design-editor/layout-operations";
import type { DesignFile } from "@/pages/design-editor/types";

export interface DistributeSelectionArgs {
...
export function runDistributeSelection(
  {
    activeFile,
    boardFileId,
    boardFrameGeometry,
