...
// use-navigation-state.ts imports useAgentRouteState via the client/navigation
// entry. In the template monorepo core is a source workspace package, so
// mocking route-state also intercepted that re-export; with core installed
// from npm the package internals are externalized and only the specifier the
// app itself imports can be mocked.
