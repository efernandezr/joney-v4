...
describe("CanvasCommentPins queued draft handling", () => {
  // SKIPPED at scaffold time: asserts a discard-warning toast whose
  // implementation is absent from this template snapshot (only the i18n
  // key shipped). Re-enable when the queued-draft discard warning lands.
  it.skip("warns instead of silently discarding a queued draft when the context changes", async () => {
